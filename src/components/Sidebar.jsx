...
const links = [
  ...
  { to: '/create-clinic', icon: PlusCircle, label: "Klinika qo'shish" },
]
          ...
          <>
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="text-sage-400 text-xs">Admin Panel</div>
              </div>
            </div>
            <button
              onClick={onToggle}
          ...
          {!collapsed && (
            <>
              <div className="flex-1 min-w-0 text-left">
                <div className="text-white text-xs font-medium truncate">System Admin</div>
              </div>
              {showUserMenu
